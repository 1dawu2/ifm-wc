...
(function () {
  ...
  function UI5(changedProperties, that) {
    ...
    if (that._firstConnectionUI5 === 0) {
      ...
      div0.innerHTML = '<?xml version="1.0"?><script id="oView_' + widgetName + '" name="oView_' + widgetName + '" type="sapui5/xmlview"><mvc:View xmlns="sap.ui.webc.main" xmlns:mvc="sap.ui.core.mvc" xmlns:core="sap.ui.core" xmlns:l="sap.ui.layout" height="100%" controllerName="myView.Template"><TabContainer><Tab additionalText="5" icon="menu2" text="Computers"><Button id="buttonId" class="sapUiSmallMarginBottom" text="Get Stories" width="150px" press=".onButtonPress" /><div id="sacTable"></div></Tab></TabContainer></mvc:View></script>';
