...
(function () {
  ...
  function UI5(changedProperties, that) {
    ...
    if (that._firstConnectionUI5 === 0) {
      ...
      div0.innerHTML = '<?xml version="1.0"?><script id="oView_' + widgetName + '" name="oView_' + widgetName + '" type="sapui5/xmlview"><mvc:View xmlns="sap.m" xmlns:mvc="sap.ui.core.mvc xmlns:l="sap.ui.layout" xmlns:core="sap.ui.core"  height="100%" controllerName="myView.Template"><Panel width="auto" class="sapUiResponsiveMargin" accessibleRole="Region"><headerToolbar><OverflowToolbar><Title text="Header"/><ToolbarSpacer /><Button id="buttonId" class="sapUiSmallMarginBottom" text="Get Stories" width="150px" press=".onButtonPress" /></OverflowToolbar></headerToolbar><content id="sacTable"></content></Panel></mvc:View></script>';
